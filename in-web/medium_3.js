...
function C(Y, Z) {
    var a0 = (Y & 0xffff) + (Z & 0xffff);
    return (((Y >> 0x10) + (Z >> 0x10) + (a0 >> 0x10)) << 0x10) | (a0 & 0xffff);
}
...
function P(Y) {
    ...
    var a1, a2 = [];
    for (a2[((Y['length'] >> 0x2) - 0x1)] = void 0x0, a1 = 0x0; (a1 < a2['length']); a1 += 0x1)
        a2[a1] = 0x0;
    var a3 = 0x8 * Y['length'];

    for (a1 = 0x0; a1 < a3; a1 += 0x8)
        a2[a1 >> 0x5] |= ((0xff & Y['charCodeAt'](a1 / 0x8)) << (a1 % 0x20));
